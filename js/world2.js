...
class World {
    ...
    updatePlayerPosition() {
        ...
        if (this.player.isGrappled) {
            ...
            this.player.yAcceleration += (INVERSE_ACC_STRENGTH_Y / Math.max(grappleLength, 1)) * (this.player.yAcceleration / Math.abs(this.player.yAcceleration));
            this.player.xAcceleration += (INVERSE_ACC_STRENGTH_Y / Math.max(grappleLength, 1)) * (this.player.xAcceleration / Math.abs(this.player.xAcceleration));
